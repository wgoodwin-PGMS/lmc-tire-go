...
def main():
    ...
    ranges = {
        ...
        "set1_S8": (0.43, 1.49),
        "set1_S9": (0.54, 1.50),
        "set1_S10": (0.50, 1.50),  # S10
        "set1_S11": (0.28, 3.40),
        "set1_S12": (set1[11], set1[11] + 1e-6),  # P Sens
        "set1_S13": (-5.0, 2.00),
        "set1_S14": (0.46, 1.10),
        "set1_S15": (0.50, 10.0),  # S15
        "set1_S16": (set1[15], set1[15] + 1e-6),  # IA Sens
        "set1_S17": (set1[16], set1[16] + 1e-6),  # P Sens
        "set1_S18": (0.35, 1.63),
        "set1_S19": (0.32, 2.00),
        "set1_S20": (0.20, 2.35),  # S20
        "set1_S21": (0.01, 8.00),
        "set1_S22": (0.52, 1.35),
        "set1_S23": (0.30, 10.25),
        "set1_S24": (0.70, 15.00),
        "set1_S25": (0.81, 10.00),  # S25
        # Set 1, LS or Front
        "set2_S1": (0.50, 2.75),  # S1
        "set2_S2": (0.48, 1.31),
        "set2_S3": (-0.5, 3.00),
        ...
        "set2_S8": (0.43, 1.49),
        "set2_S9": (0.54, 1.50),
        "set2_S10": (0.50, 1.50),  # S10
        "set2_S11": (0.28, 3.40),
        "set2_S12": (set2[11], set2[11] + 1e-6),  # P Sens
        "set2_S13": (-5.0, 2.00),
        "set2_S14": (0.46, 1.10),
        "set2_S15": (0.50, 10.0),  # S15
        "set2_S16": (set2[15], set2[15] + 1e-6),  # IA Sens
        "set2_S17": (set2[16], set2[16] + 1e-6),  # P Sens
        "set2_S18": (0.35, 1.63),
        "set2_S19": (0.32, 2.00),
        "set2_S20": (0.20, 2.35),  # S20
        "set2_S21": (0.01, 8.00),
        "set2_S22": (0.52, 1.35),
        "set2_S23": (0.30, 10.25),
        "set2_S24": (0.70, 15.00),
        "set2_S25": (0.81, 10.00),  # S25
    }

    temp_uuid = str(uuid.uuid4())

    phase_one = parameter_screen.parameterScreen(
        population_ranges=ranges, username=UN, password=PW, road_course=road_course
    )
